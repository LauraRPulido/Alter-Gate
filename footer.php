...
<footer id="footer" class="container-fluid py-5">
    ...
    <div class="container">
        <div class="row justify-content-between">
                ...
                <div class="col-md-4 text-center text-md-start" >
                    ...
                    <form class="d-flex flex-column mx-auto mx-md-0 align-items-center align-items-md-stretch" style="max-width: 300px;" >
                        <div class="mb-3">
                            <input type="email" class="formFooter text-light" id="email" placeholder="Email">
                        </div>
                        ...
                        <button type="submit" class="botonForm my-3">Suscribirse</button>
                    </form>
    ...
    <div class="footer-copyright text-center mt-5 pt-4">
